...
void hours_cb(struct menu_t *h) {
   ...
   //G_debug[0] = 0;
   //strcpy(G_debug, "hrs dst ");
   //strcat(G_debug, dstMenu->name);
   //strcat(G_debug, " src ");
   //strcat(G_debug, selectedMenu->name);
...
void minsOnes_cb(struct menu_t *m) {
   ...
   G_debug[0] = 0;
   strcpy(G_debug, " dst ");
   strcat(G_debug, minsOnesMenu->name);
   strcat(G_debug, " src ");
   strcat(G_debug, selectedMenu->name);
   ...
   strcat(G_debug, " tens ");
   strcat(G_debug, minsTensMenu->name);
   strcat(G_debug, " ones ");
   strcat(G_debug, minsOnesMenu->name);
...
struct menu_t time_m[] = {
    {"Hour",   VERT_ITEM,     MENU, {(struct menu_t *)hours_m} },
    {"Min",   HORIZ_ITEM,     MENU, {(struct menu_t *)mins_m} },
//    {"AM",   HORIZ_ITEM,     MENU, {(struct menu_t *)AMPM_m} },
    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
};
...
//struct menu_t myBadgeNum_m[] = {
//    {"get", 1|VERT_ITEM, FUNCTION, {(struct menu_t *)myBadgeid_cb} },
//    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
//};

struct menu_t myBadgeid_m[] = {
    {"check",   HORIZ_ITEM,     FUNCTION, {(struct menu_t *)myBadgeid_cb} },
    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
};
...
struct menu_t peerBadgeid_m[] = {
    {"0",   HORIZ_ITEM,     MENU, {peerBadgeNum_m} },
    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
};
...
struct menu_t backlight_m[] = {
    {"-------",   HORIZ_ITEM,     MENU, {backlightList_m} },
    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
};
...
struct menu_t LEDlight_m[] = {
    {"--------",   HORIZ_ITEM,     MENU, {LEDlightList_m} },
    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
};
...
struct menu_t buzzer_m[] = {
    {"Buzzer: On",   HORIZ_ITEM|DEFAULT_ITEM,     MENU, {buzzer_config_m} },
    {"Back", VERT_ITEM|LAST_ITEM, BACK, {NULL} },
};
