...
#define DC_PIN A0_PIN
#define SDIN_PIN SDA_PIN
#define SCE_PIN nCS_PIN
...
void S6B33_send_command(unsigned char data) {
  SCE_PIN = 0; /* chip enable active low */
  DC_PIN = LCD_COMMAND; /* COMMAND = 8 bit */

  SDIN_PIN = (data & 0b10000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b01000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b00100000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b00010000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b00001000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b00000100) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b00000010) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b00000001) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;
...
void S6B33_send_data(unsigned short data) {
  ...
  DC_PIN = LCD_DATA; /* data = 16 bit */

  SDIN_PIN = (data & 0b1000000000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0100000000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0010000000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0001000000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000100000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000010000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000001000000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000100000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000010000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000001000000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000000100000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000000010000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000000001000) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000000000100) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000000000010) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;

  SDIN_PIN = (data & 0b0000000000000001) ? 1 : 0;
  SCLK_PIN = 1;
  SCLK_PIN = 0;
//  SDIN_PIN = 0;
